<template>
  ...
  <br />
  <br />
  <base-button mode="secondary" @click="modalOpen = true">Open Modal</base-button>
  <base-dialog :open="modalOpen" @close="modalOpen = false">
    <template v-slot:header>
      <h3 style="margin: 0">Are you sure?</h3>
    </template>
    <p>All the progress will be lost</p>
  </base-dialog>
  <the-modal />
</template>
